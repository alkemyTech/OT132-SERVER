...
public class UserSeeder implements CommandLineRunner {
  ...
  private static final String[] NAMES = {"Luitgard", "Christel", "Stefanie", "Oswald",
      "Ottomar", "Johann", "Moses", "Ianis", "Ashlyn", "Maria", "Kunigunde", "Marlies",
      "Lieselotte", "Carina", "Gabriele", "Gertrud", "Cecilia", "Sonje", "Gitte", "Auguste"};
  private static final String[] LASTNAMES = {"Dettler", "Kampmann", "Wesener",
      ...
      "Wagner-Kees"};
  private static final String[] EMAILS = {"etluit12@gmail.com", "epchristel15@gmail.com",
  ...
  private static final String[] PASSWORDS = {"t0400e3ps", "p00846e4p", "f94475j9f",
